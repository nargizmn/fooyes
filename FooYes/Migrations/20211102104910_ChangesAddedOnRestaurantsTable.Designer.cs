...
namespace FooYes.Migrations
{
    ...
    [Migration("20211102104910_ChangesAddedOnRestaurantsTable")]
    partial class ChangesAddedOnRestaurantsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FooYes.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FooYes.Models.CommentRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FooYes.Models.Favourite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FooYes.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FooYes.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FooYes.Models.Restaurant", b =>
                {
                    ...
                    b.Property<double?>("PunctualityRate")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("FooYes.Models.CommentRate", b =>
                {
                    ...
                    b.HasOne("FooYes.Models.Comment", "Comment")
                        .WithMany("CommentRates")
            ...
            modelBuilder.Entity("FooYes.Models.Order", b =>
                {
                    ...
                    b.HasOne("FooYes.Models.Rider", "Rider")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FooYes.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("FooYes.Models.Order", "Order")
                        .WithMany("OrderItems")
